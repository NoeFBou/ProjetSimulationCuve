...
public class Cuve
{
	...
	public static Cuve fabriquerCuve(int capacite) {
		if (capacite < 200 || capacite > 1000 || (char) (Cuve.idCuveAutoIncre + 1) > 'Z')
			return null;
	...
	public int getPosX() {
		return this.positionsXY[0];
	}

	public int getPosY() {
		return this.positionsXY[1];
	}

	public String getPosInfos() {
	...
	public void setPosX(int posX) {
		this.positionsXY[0] = posX;
	}

	public void setPosY(int posY) {
		this.positionsXY[1] = posY;
	}
